...
has no narrator fallback; the Stage 4 speech trigger is future work. Music is owned
...
`candidate`, `concern`, and `simulated`. Successful dialogue also has `utterance`,
